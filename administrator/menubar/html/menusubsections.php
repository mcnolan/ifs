		...
		function NEW_MENU_subsections($option, $sections){ ?>
			...
			<TR>
				...
				<TD VALIGN="bottom" BGCOLOR="#999999" WIDTH="51%">
					...
					<TR>
						<TD WIDTH="50" VALIGN='bottom' BGCOLOR="#999999"><A HREF="javascript:document.location.href='index2.php?option=<? echo $option; ?>&sections=<?echo $sections;?>'" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('cancel','','../images/admin/cancel_f2.gif',1);"><IMG SRC="../images/admin/cancel.gif" ALT="Cancel" WIDTH="34" HEIGHT="47" BORDER="0" NAME="cancel" HSPACE="5" VPSACE="0"></A></TD>
						<TD WIDTH="270">&nbsp;</TD>
					</TR>
					</TABLE>
				</TD>
				...
				<TR>
					...
					<TD VALIGN="bottom" BGCOLOR="#999999" WIDTH="51%">
						...
						<TR>
							...
							<?}?>
							<TD WIDTH="50" VALIGN='bottom' BGCOLOR="#999999"><A HREF="javascript:document.location.href='menubar/cancel.php?id=<? echo $comcid; ?>&option=<? echo $option; ?>&sections=<?echo $sections;?>';" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('cancel','','../images/admin/cancel_f2.gif',1);"><IMG SRC="../images/admin/cancel.gif" ALT="Cancel" WIDTH="34" HEIGHT="47" BORDER="0" NAME="cancel" HSPACE="5" VPSACE="0"></A></TD>
							<TD WIDTH="370">&nbsp;</TD>
						</TR>
						</TABLE>
					</TD>
			...
			<TABLE CELLSPACING="0" CELLPADDING="0" BORDER="0" WIDTH="100%">
				<TR>
					...
					<TD VALIGN="bottom" BGCOLOR="#999999" WIDTH="51%">
						...
						<TR>
							<?if ($PageSource!="Link"){?>
								<TD WIDTH="50" VALIGN='bottom' BGCOLOR="#999999"><A HREF="javascript:submitbutton('savenew<?echo $PageSource;?>', 'subsections');" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('save','','../images/admin/save_f2.gif',1);"><IMG SRC="../images/admin/save.gif" ALT="Publish" WIDTH="36" HEIGHT="47" BORDER="0" NAME="save" HSPACE="5" VPSACE="0"></A></TD>
			    			<?}?>
							<TD WIDTH="50" VALIGN='bottom' BGCOLOR="#999999"><A HREF="index2.php?option=<?echo $option;?>&sections=<?echo $sections;?>" onMouseOut="MM_swapImgRestore();"  onMouseOver="MM_swapImage('cancel','','../images/admin/cancel_f2.gif',1);"><IMG SRC="../images/admin/cancel.gif" ALT="Cancel" WIDTH="34" HEIGHT="47" BORDER="0" NAME="cancel" HSPACE="5" VPSACE="0"></A></TD>
							<TD WIDTH="370">&nbsp;</TD>
						</TR>
						</TABLE>
					</TD>
